...
The `iris` data \index{data exploration} is used in this chapter for demonstration of data exploration with R. See Section \@ref(iris) for details of the `iris` data.
